---
name: skill-share
description: A skill that creates new Anymous skills and automatically shares them on Slack using Rube for seamless team collaboration and skill discovery.
...
- **Create new Anymous skills** with proper structure and metadata
...
```
When you ask Anymous to create a skill called "pdf-analyzer":
