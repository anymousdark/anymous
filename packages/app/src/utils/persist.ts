...
const GLOBAL_STORAGE = "anymous.global.dat"
const WINDOW_STORAGE = "anymous.window"
const LOCAL_PREFIX = "anymous."
...
function workspaceStorage(dir: string) {
  ...
  return `anymous.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `anymous.draft.${head}.${sum}.dat`
}
