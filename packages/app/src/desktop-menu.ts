...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "anymous Documentation", href: "https://anymous-cli.vercel.app/docs" },
      { type: "item", label: "Support Forum", href: "https://discord.com/invite/anymous" },
      { type: "item", label: "Export Logs...", command: "logs.export" },
      { type: "separator" },
      {
        type: "item",
        label: "Share Feedback",
        href: "https://github.com/anymousdark/anymous/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/anymousdark/anymous/issues/new?template=bug_report.yml",
      },
    ],
  },
]
