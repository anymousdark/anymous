...
import { showToast } from "@anymous-ai/ui/toast"
...
import { LoaderV2 } from "@anymous-ai/ui/v2/loader-v2"
import { RadioGroupV2, RadioItemV2 } from "@anymous-ai/ui/v2/radio-v2"
...
function useWslAddServerController(props: DialogWslServerProps) {
  ...
  const runPrimary = async () => {
    ...
    if (action === "install-anymous") {
      await run(() => api.installanymous(distro))
      return
    }
