import type { anymousEvent, SessionMessageInfo, SessionPendingMessage } from "@anymous-ai/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: anymousEvent): V2SessionReduction | undefined => {
