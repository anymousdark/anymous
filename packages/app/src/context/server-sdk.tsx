import type { anymousEvent } from "@anymous-ai/client/promise"
import type { Event } from "@anymous-ai/sdk/v2/client"
...
export type ServerEvent = Event & { current?: anymousEvent }
...
export function adaptServerEvent(event: anymousEvent): ServerEvent {
...
function currentDelta(event: anymousEvent | undefined): CurrentDelta | undefined {
  if (
