import type { SessionApi } from "@anymous-ai/client/promise"
import { normalizeSessionInfo } from "@/utils/session"
import type { anymousClient } from "@anymous-ai/sdk/v2/client"
...
export async function loadRootSessionsV1(input: { client: anymousClient; directory: string; limit: number }) {
  try {
