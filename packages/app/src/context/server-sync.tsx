...
export const loadLspQuery = (scope: ServerScope, directory: string, sdk: anymousClient) =>
  queryOptions({
...
function makeQueryOptionsApi(
  scope: ServerScope,
  serverSDK: () => anymousClient,
  serverAPI: ServerApi,
  sdkFor: (dir: PathKey) => anymousClient,
  protocol: Promise<"v1" | "v2">,
) {
  return {
...
export function createServerSyncContextInner(serverSDK: ServerSDK) {
  ...
  const sdkCache = new Map<string, anymousClient>()
