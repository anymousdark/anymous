  ...
  test("moves an existing canonical web bucket into local scope", () => {
    expect(
      migrateCanonicalLocalServerState(
        {
          list: [],
          projects: { "https://anymous.example.com": [{ worktree: "/remote", expanded: true }] },
          lastProject: { "https://anymous.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://anymous.example.com"),
      ),
    ).toEqual({
      list: [],
      ...
      migrateCanonicalLocalServerState(
        {
          projects: {
            ...
            "https://anymous.example.com": [
              { worktree: "/local", expanded: true },
              { worktree: "/remote", expanded: true },
            ],
          },
          lastProject: { local: "/local", "https://anymous.example.com": "/remote" },
        },
        ServerConnection.Key.make("https://anymous.example.com"),
      ),
    ).toEqual({
