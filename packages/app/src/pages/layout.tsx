...
import { toaster } from "@anymous-ai/ui/toast"
...
import { retry } from "@anymous-ai/core/util/retry"
...
import { useTheme, type ColorScheme } from "@anymous-ai/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://anymous-cli.vercel.app/desktop-feedback")}
      renderPanel={() =>
