export const dict = {
  ...
  "dialog.provider.anymous.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.anymous.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.anymousGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "anymousが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、anymousで{{provider}}モデルを使用します。",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.anymousZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.anymousZen.visit.prefix": " ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してanymousで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、anymousで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "anymous.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するanymousサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkinganymous": "anymousを確認中...",
  "wsl.onboarding.checkinganymousIn": "{{distro}}内のanymousを確認中...",
  "wsl.onboarding.updatinganymous": "anymousを更新中...",
  "wsl.onboarding.updatinganymousIn": "{{distro}}内のanymousを更新中...",
  "wsl.onboarding.updateanymousIn": "{{distro}}内のanymousを更新してください。",
  "wsl.onboarding.updateanymous": "anymousを更新",
  "wsl.onboarding.anymousReadyIn": "{{distro}}内のanymousの準備ができました。",
  "wsl.onboarding.anymousReady": "anymousの準備ができました。",
  "wsl.onboarding.installanymousIn": "{{distro}}にanymousをインストールしてください。",
  "wsl.onboarding.installanymous": "anymousをインストール",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymousがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "anymousでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、anymousをもう一度開いてください。",
  ...
  "toast.update.description": "anymousの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをanymousチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (anymous.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: anymousはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "anymousには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でanymousサーバーを実行します。",
  ...
  "settings.general.row.language.description": "anymousの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのanymousの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "anymousがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "anymousのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "anymous の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "anymous は最新バージョンです。",
