...
export const dict = {
  ...
  "dialog.provider.anymous.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.anymous.tagline": "Güvenilir optimize edilmiş modeller",
  "dialog.provider.anymousGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "anymous tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve anymous'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.anymousZen.visit.prefix": "",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak anymous'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak anymous'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler anymous.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi anymous sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkinganymous": "anymous kontrol ediliyor...",
  "wsl.onboarding.checkinganymousIn": "{{distro}} içinde anymous kontrol ediliyor...",
  "wsl.onboarding.updatinganymous": "anymous güncelleniyor...",
  "wsl.onboarding.updatinganymousIn": "{{distro}} içinde anymous güncelleniyor...",
  "wsl.onboarding.updateanymousIn": "{{distro}} içindeki anymous'u güncelleyin.",
  "wsl.onboarding.updateanymous": "anymous'u güncelle",
  "wsl.onboarding.anymousReadyIn": "{{distro}} içinde anymous hazır.",
  "wsl.onboarding.anymousReady": "anymous hazır.",
  "wsl.onboarding.installanymousIn": "anymous'u {{distro}} içine kurun.",
  "wsl.onboarding.installanymous": "anymous'u kur",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "anymous'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "anymous bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından anymous'u tekrar açın.",
  ...
  "toast.update.description": "anymous'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı anymous ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (anymous.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: anymous henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "anymous ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "anymous Masaüstü",
  ...
  "settings.desktop.wsl.description": "anymous sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "anymous'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "anymous'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "anymous'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "anymous'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "anymous başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "anymous'un en son sürümünü kullanıyorsunuz.",
