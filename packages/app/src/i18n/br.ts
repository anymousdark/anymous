export const dict = {
  ...
  "dialog.provider.anymous.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.anymous.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.anymousGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo anymous",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no anymous.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  "provider.connect.anymousZen.line2":
    "Com uma única chave de API você terá acesso a modelos como Claude, GPT, Gemini, GLM e mais.",
  "provider.connect.anymousZen.visit.prefix": "Visite ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no anymous.",
  ...
  "dialog.plugins.empty": "Plugins configurados em anymous.json",
  ...
  "dialog.server.description": "Trocar para qual servidor anymous este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkinganymous": "Verificando o anymous...",
  "wsl.onboarding.checkinganymousIn": "Verificando o anymous em {{distro}}...",
  "wsl.onboarding.updatinganymous": "Atualizando o anymous...",
  "wsl.onboarding.updatinganymousIn": "Atualizando o anymous em {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Atualize o anymous em {{distro}}.",
  "wsl.onboarding.updateanymous": "Atualizar o anymous",
  "wsl.onboarding.anymousReadyIn": "O anymous está pronto em {{distro}}.",
  "wsl.onboarding.anymousReady": "O anymous está pronto.",
  "wsl.onboarding.installanymousIn": "Instale o anymous em {{distro}}.",
  "wsl.onboarding.installanymous": "Instalar o anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o anymous possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O anymous não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o anymous novamente.",
  ...
  "toast.update.description": "Uma nova versão do anymous ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do anymous",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (anymous.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: anymous ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "anymous inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor anymous dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do anymous",
  ...
  "settings.general.row.appearance.description": "Personalize como o anymous aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o anymous segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o anymous é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o anymous iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do anymous.",
