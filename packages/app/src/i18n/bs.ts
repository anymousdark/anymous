export const dict = {
  ...
  "dialog.provider.anymous.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.anymous.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.anymousGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje anymous",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u anymous-u.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  "provider.connect.anymousZen.line2":
    "Sa jednim API ključem dobijaš pristup modelima kao što su Claude, GPT, Gemini, GLM i drugi.",
  "provider.connect.anymousZen.visit.prefix": "Posjeti ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u anymous-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u anymous-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u anymous.json",
  ...
  "dialog.server.description": "Promijeni na koji se anymous server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkinganymous": "Provjera anymous...",
  "wsl.onboarding.checkinganymousIn": "Provjera anymous u distribuciji {{distro}}...",
  "wsl.onboarding.updatinganymous": "Ažuriranje anymous...",
  "wsl.onboarding.updatinganymousIn": "Ažuriranje anymous u distribuciji {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Ažuriraj anymous u distribuciji {{distro}}.",
  "wsl.onboarding.updateanymous": "Ažuriraj anymous",
  "wsl.onboarding.anymousReadyIn": "anymous je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.anymousReady": "anymous je spreman.",
  "wsl.onboarding.installanymousIn": "Instaliraj anymous u distribuciji {{distro}}.",
  "wsl.onboarding.installanymous": "Instaliraj anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi anymous mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "anymous nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori anymous.",
  ...
  "toast.update.description": "Nova verzija anymous-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku anymous timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (anymous.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: anymous još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "anymous uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni anymous server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u anymous-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako anymous izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li anymous prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu anymous-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se anymous pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju anymous-a.",
