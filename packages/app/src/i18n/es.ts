export const dict = {
  ...
  "dialog.provider.anymous.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.anymous.tagline": "Modelos optimizados y fiables",
  "dialog.provider.anymousGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por anymous",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en anymous.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  "provider.connect.anymousZen.line2":
    "Con una sola clave API obtendrás acceso a modelos como Claude, GPT, Gemini, GLM y más.",
  "provider.connect.anymousZen.visit.prefix": "Visita ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en anymous.",
  ...
  "dialog.plugins.empty": "Plugins configurados en anymous.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de anymous se conecta esta app.",
  ...
  "wsl.onboarding.checkinganymous": "Comprobando anymous...",
  "wsl.onboarding.checkinganymousIn": "Comprobando anymous en {{distro}}...",
  "wsl.onboarding.updatinganymous": "Actualizando anymous...",
  "wsl.onboarding.updatinganymousIn": "Actualizando anymous en {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Actualiza anymous en {{distro}}.",
  "wsl.onboarding.updateanymous": "Actualizar anymous",
  "wsl.onboarding.anymousReadyIn": "anymous está listo en {{distro}}.",
  "wsl.onboarding.anymousReady": "anymous está listo.",
  "wsl.onboarding.installanymousIn": "Instala anymous en {{distro}}.",
  "wsl.onboarding.installanymous": "Instalar anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que anymous pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "anymous no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir anymous.",
  ...
  "toast.update.description": "Una nueva versión de anymous ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de anymous",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (anymous.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, anymous no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "anymous incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor anymous dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para anymous",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve anymous en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si anymous sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de anymous.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia anymous",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de anymous.",
