...
export const dict = {
  ...
  "dialog.provider.anymous.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.anymous.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.anymousGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av anymous",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i anymous.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  "provider.connect.anymousZen.line2":
    "Med én enkelt API-nøkkel får du tilgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.anymousZen.visit.prefix": "Besøk ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i anymous.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i anymous.json",
  ...
  "dialog.server.description": "Bytt hvilken anymous-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av anymous ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til anymous-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (anymous.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at anymous ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "anymous inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør anymous-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for anymous",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan anymous ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description": "Velg om anymous skal følge systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan anymous er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når anymous starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av anymous.",
  ...
  "wsl.onboarding.checkinganymous": "Sjekker anymous...",
  "wsl.onboarding.checkinganymousIn": "Sjekker anymous i {{distro}}...",
  "wsl.onboarding.updatinganymous": "Oppdaterer anymous...",
  "wsl.onboarding.updatinganymousIn": "Oppdaterer anymous i {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Oppdater anymous i {{distro}}.",
  "wsl.onboarding.updateanymous": "Oppdater anymous",
  "wsl.onboarding.anymousReadyIn": "anymous er klar i {{distro}}.",
  "wsl.onboarding.anymousReady": "anymous er klar.",
  "wsl.onboarding.installanymousIn": "Installer anymous i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før anymous kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "anymous kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter anymous på nytt.",
