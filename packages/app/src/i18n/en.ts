export const dict = {
  ...
  "dialog.provider.anymous.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.anymous.tagline": "Reliable optimized models",
  "dialog.provider.anymousGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by anymous",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in anymous.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.anymousZen.line1":
    "anymous Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.anymousZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.anymousZen.visit.prefix": "Visit ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in anymous.",
  ...
  "dialog.plugins.empty": "Plugins configured in anymous.json",
  ...
  "dialog.server.description": "Switch which anymous server this app connects to.",
  ...
  "wsl.onboarding.checkinganymous": "Checking anymous...",
  "wsl.onboarding.checkinganymousIn": "Checking anymous in {{distro}}...",
  "wsl.onboarding.updatinganymous": "Updating anymous...",
  "wsl.onboarding.updatinganymousIn": "Updating anymous in {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Update anymous in {{distro}}.",
  "wsl.onboarding.updateanymous": "Update anymous",
  "wsl.onboarding.anymousReadyIn": "anymous is ready in {{distro}}.",
  "wsl.onboarding.anymousReady": "anymous is ready.",
  "wsl.onboarding.installanymousIn": "Install anymous in {{distro}}.",
  "wsl.onboarding.installanymous": "Install anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before anymous can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "anymous could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen anymous.",
  ...
  "toast.update.description": "A new version of anymous ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the anymous team",
  ...
  "error.chain.checkConfig": "Check your config (anymous.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, anymous does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "anymous includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the anymous server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for anymous",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how anymous looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether anymous follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how anymous is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when anymous launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of anymous.",
