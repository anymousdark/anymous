export const dict = {
  ...
  "dialog.provider.anymous.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.anymous.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.anymousGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af anymous",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i anymous.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.anymousZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.anymousZen.visit.prefix": "Besøg ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i anymous.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i anymous.json",
  ...
  "dialog.server.description": "Skift hvilken anymous-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkinganymous": "Tjekker anymous...",
  "wsl.onboarding.checkinganymousIn": "Tjekker anymous i {{distro}}...",
  "wsl.onboarding.updatinganymous": "Opdaterer anymous...",
  "wsl.onboarding.updatinganymousIn": "Opdaterer anymous i {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Opdater anymous i {{distro}}.",
  "wsl.onboarding.updateanymous": "Opdater anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før anymous kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "anymous kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter anymous igen.",
  ...
  "toast.update.description": "En ny version af anymous ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til anymous-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (anymous.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, anymous understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "anymous inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør anymous-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for anymous",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan anymous ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description": "Vælg om anymous følger systemets, lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan anymous er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når anymous starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af anymous.",
