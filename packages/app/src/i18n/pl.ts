export const dict = {
  ...
  "dialog.provider.anymous.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.anymous.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.anymousGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez anymous",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w anymous.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.anymousZen.visit.prefix": "Odwiedź ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w anymous.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w anymous.json",
  ...
  "dialog.server.description": "Przełącz serwer anymous, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkinganymous": "Sprawdzanie anymous...",
  "wsl.onboarding.checkinganymousIn": "Sprawdzanie anymous w dystrybucji {{distro}}...",
  "wsl.onboarding.updatinganymous": "Aktualizowanie anymous...",
  "wsl.onboarding.updatinganymousIn": "Aktualizowanie anymous w dystrybucji {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Zaktualizuj anymous w dystrybucji {{distro}}.",
  "wsl.onboarding.updateanymous": "Zaktualizuj anymous",
  "wsl.onboarding.anymousReadyIn": "anymous jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.anymousReady": "anymous jest gotowy.",
  "wsl.onboarding.installanymousIn": "Zainstaluj anymous w dystrybucji {{distro}}.",
  "wsl.onboarding.installanymous": "Zainstaluj anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim anymous będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "anymous nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz anymous.",
  ...
  "toast.update.description": "Nowa wersja anymous ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu anymous",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (anymous.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: anymous nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "anymous zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer anymous wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla anymous",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd anymous na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy anymous ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw anymous.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania anymous",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji anymous.",
