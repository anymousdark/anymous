export const dict = {
  ...
  "dialog.provider.anymous.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.anymous.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.anymousGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من anymous",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح واجهة برمجة تطبيقات {{provider}} الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في anymous.",
  ...
  "provider.connect.anymousZen.line1":
    "يمنحك anymous Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.anymousZen.visit.prefix": "قم بزيارة ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix": " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في anymous.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في anymous.json",
  ...
  "dialog.server.description": "تبديل خادم anymous الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkinganymous": "جارٍ التحقق من anymous...",
  "wsl.onboarding.checkinganymousIn": "جارٍ التحقق من anymous في {{distro}}...",
  "wsl.onboarding.updatinganymous": "جارٍ تحديث anymous...",
  "wsl.onboarding.updatinganymousIn": "جارٍ تحديث anymous في {{distro}}...",
  "wsl.onboarding.updateanymousIn": "حدّث anymous في {{distro}}.",
  "wsl.onboarding.updateanymous": "تحديث anymous",
  "wsl.onboarding.anymousReadyIn": "anymous جاهز في {{distro}}.",
  "wsl.onboarding.anymousReady": "anymous جاهز.",
  "wsl.onboarding.installanymousIn": "ثبّت anymous في {{distro}}.",
  "wsl.onboarding.installanymous": "تثبيت anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن anymous من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على anymous التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح anymous.",
  ...
  "toast.update.description": "نسخة جديدة من anymous ({{version}}) متاحة الآن للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق anymous",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (anymous.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن anymous لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن anymous نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم anymous داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ anymous",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور anymous على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان anymous يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة anymous.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل anymous",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من anymous.",
