...
export const dict = {
  ...
  "dialog.provider.anymous.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.anymous.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.anymousGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von anymous",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in anymous zu nutzen.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.anymousZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.anymousZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in anymous zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in anymous zu nutzen.",
  ...
  "dialog.plugins.empty": "In anymous.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den anymous-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.anymous": "anymous",
  ...
  "wsl.onboarding.checkinganymous": "anymous wird geprüft...",
  "wsl.onboarding.checkinganymousIn": "anymous in {{distro}} wird geprüft...",
  "wsl.onboarding.updatinganymous": "anymous wird aktualisiert...",
  "wsl.onboarding.updatinganymousIn": "anymous in {{distro}} wird aktualisiert...",
  "wsl.onboarding.updateanymousIn": "Aktualisieren Sie anymous in {{distro}}.",
  "wsl.onboarding.updateanymous": "anymous aktualisieren",
  "wsl.onboarding.anymousReadyIn": "anymous ist in {{distro}} bereit.",
  "wsl.onboarding.anymousReady": "anymous ist bereit.",
  "wsl.onboarding.installanymousIn": "Installieren Sie anymous in {{distro}}.",
  "wsl.onboarding.installanymous": "anymous installieren",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor anymous einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "anymous konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann anymous erneut.",
  ...
  "toast.update.description": "Eine neue Version von anymous ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem anymous-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (anymous.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: anymous unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "anymous enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "anymous Desktop",
  ...
  "settings.desktop.wsl.description": "anymous-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für anymous ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie anymous auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description": "Wählen Sie, ob anymous dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von anymous anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von anymous automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von anymous.",
