export const dict = {
  ...
  "dialog.provider.anymous.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.anymous.tagline": "Modèles optimisés et fiables",
  "dialog.provider.anymousGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par anymous",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans anymous.",
  ...
  "provider.connect.anymousZen.line1":
    "anymous Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.anymousZen.visit.prefix": "Visitez ",
  "provider.connect.anymousZen.visit.link": "anymous-cli.vercel.app/zen",
  "provider.connect.anymousZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans anymous.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans anymous.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans anymous.json",
  ...
  "dialog.server.description": "Changez le serveur anymous auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkinganymous": "Vérification d'anymous...",
  "wsl.onboarding.checkinganymousIn": "Vérification d'anymous dans {{distro}}...",
  "wsl.onboarding.updatinganymous": "Mise à jour d'anymous...",
  "wsl.onboarding.updatinganymousIn": "Mise à jour d'anymous dans {{distro}}...",
  "wsl.onboarding.updateanymousIn": "Mettez à jour anymous dans {{distro}}.",
  "wsl.onboarding.updateanymous": "Mettre à jour anymous",
  "wsl.onboarding.anymousReadyIn": "anymous est prêt dans {{distro}}.",
  "wsl.onboarding.anymousReady": "anymous est prêt.",
  "wsl.onboarding.installanymousIn": "Installez anymous dans {{distro}}.",
  "wsl.onboarding.installanymous": "Installer anymous",
  ...
  "wsl.onboarding.distroStatus.anymousMissing": "anymous non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'anymous puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "anymous n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez anymous.",
  ...
  "toast.update.description":
    "Une nouvelle version d'anymous ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe anymous",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (anymous.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'anymous ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1": "anymous inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur anymous dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour anymous",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'anymous sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si anymous suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'anymous.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'anymous",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'anymous.",
