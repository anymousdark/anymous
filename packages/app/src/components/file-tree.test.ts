...
beforeAll(async () => {
  ...
  mock.module("@anymous-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@anymous-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@anymous-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@anymous-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
