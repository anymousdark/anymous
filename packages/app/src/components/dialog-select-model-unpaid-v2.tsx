...
import { Icon } from "@anymous-ai/ui/v2/icon"
...
import { useTheme } from "@anymous-ai/ui/theme"
...
const featuredProviders = ["anymous", "anymous-go", "openai", "anthropic", "google", "github-copilot"]
...
export const DialogSelectModelUnpaidV2: Component<{ model?: ModelState }> = (props) => {
  ...
  const isFree = (item: ReturnType<ModelState["list"]>[number]) =>
    item.provider.id === "anymous" && (!item.cost || item.cost.input === 0)
