...
import { Iconanymous } from "./icons/custom"
import { ShareI18nProvider, formatCurrency, formatNumber, normalizeLocale } from "./share/common"
import styles from "./share.module.css"
import type { MessageV2 } from "anymous/session/message-v2"
import type { Message } from "anymous/session/message"
import type { Session } from "anymous/session/index"
          ...
          <div data-component="header">
            ...
            <div data-component="header-details">
              <ul data-component="header-stats">
                <li title={props.messages.ANYMOUS_version} data-slot="item">
                  <div data-slot="icon" title={props.messages.ANYMOUS_name}>
                    <Iconanymous width={16} height={16} />
                  </div>
