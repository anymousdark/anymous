...
Crear `.anymous/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración anymous o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su anymous [config](/docs/config):
...
anymous incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
