---
title: TUI
description: استخدام واجهة المستخدم TUI في anymous.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر anymous واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل anymous إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة anymous في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى anymous. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من anymous. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `anymous.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار anymous بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `anymous.default`.
