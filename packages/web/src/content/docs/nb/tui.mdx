---
title: TUI
description: Bruke anymous-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

anymous gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre anymous starter TUI for gjeldende katalog.
...
Når du bruker anymous TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til anymous. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt anymous. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `anymous.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge anymous venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `anymous.default`.
