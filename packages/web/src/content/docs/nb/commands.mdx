...
Opprett `.anymous/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom anymous-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i anymous [config](/docs/config):
...
anymous inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
