...
Agentferdigheter lar anymous oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går anymous opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
anymous viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `anymous.json`:
