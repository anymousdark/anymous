---
title: LSP-servere
description: anymous integreres med LSP-serverne dine.
---

anymous kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

anymous kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `ANYMOUS_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og anymous åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i anymous-konfigurasjonen.
