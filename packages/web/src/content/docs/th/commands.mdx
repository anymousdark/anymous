...
สร้าง `.anymous/commands/test.md`:
...
ใช้ส่วน `command` ในไฟล์ [config](/docs/config) ของ anymous:
...
- ระดับผู้ใช้ (Global): `~/.config/anymous/commands/`
- ระดับโปรเจ็กต์: `.anymous/commands/`
...
anymous มีคำสั่งในตัวหลายคำสั่ง เช่น `/init`, `/undo`, `/redo`, `/share`, `/help` [เรียนรู้เพิ่มเติม](/docs/tui#คำสั่ง)
