---
title: Teilen
description: Teile anymous-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu anymous-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht anymous Folgendes:
...
anymous hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt anymous den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`anymous.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du anymous in deiner Organisation einsetzt.
