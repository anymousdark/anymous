...
Puoi aggiungere comandi personalizzati tramite la config di anymous o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di anymous:
...
- Globale: `~/.config/anymous/commands/`
- Per progetto: `.anymous/commands/`
...
anymous include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
