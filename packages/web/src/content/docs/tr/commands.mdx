...
`.anymous/commands/test.md` oluştur:
...
anymous işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

anymous [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/anymous/commands/`
- Proje başına: `.anymous/commands/`
...
anymous, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
