...
Ajan becerileri, anymous'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
anymous su konumlari tarar:

- Proje konfigurasyonu: `.anymous/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/anymous/skills/<name>/SKILL.md`
...
Proje yerel yollarinda anymous, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.anymous/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/anymous/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.anymous/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
anymous, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`anymous.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`anymous.json` icinde):
