---
title: Özel Araçlar
description: LLM'un anymous'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. anymous'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.anymous/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/anymous/tools/` içine yerleştirerek.
