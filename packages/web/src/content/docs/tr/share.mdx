---
title: Paylasim
description: anymous konusmalarini genel baglantilarla paylasin.
---

anymous'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda anymous:
...
anymous, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak anymous manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `anymous.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda anymous kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
