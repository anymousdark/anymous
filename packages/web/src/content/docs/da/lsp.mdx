---
title: LSP-servere
description: anymous integreres med dine LSP-servere.
---

anymous kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

anymous leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `ANYMOUS_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og anymous åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din anymous-konfiguration.
