---
title: TUI
description: Brug af anymous-terminalbrugergrænsefladen.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

anymous giver en interaktiv terminalgrænseflade eller TUI til at arbejde med dine projekter med en LLM.

At køre anymous starter TUI for den nuværende mappe.
...
Når du bruger anymous TUI, kan du skrive `/` efterfulgt af et kommandonavn for hurtigt at udføre handlinger. For eksempel:
...
Tilføj en udbyder til anymous. Lader dig vælge fra tilgængelige udbydere og tilføje deres API-nøgler.
...
Afslut anymous. _Aliaser_: `/quit`, `/q`
...
Dette er adskilt fra `anymous.json`, som konfigurerer server-/kørselstidsadfærd.
...
- `leader_timeout` - Styrer hvor længe anymous venter efter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID der skal bruges. Standard er `anymous.default`.
