---
title: Share
description: Share your anymous conversations.
---

anymous's share feature allows you to create public links to your anymous conversations, so you can collaborate with teammates or get help from others.
...
When you share a conversation, anymous:
...
anymous supports three sharing modes that control how conversations are shared:

---

### Manual (default)

By default, anymous uses manual sharing mode. Sessions are not shared automatically, but you can manually share them using the `/share` command:
...
To enforce this across your team for a given project, add it to the `anymous.json` in your project and check into Git.
...
[Learn more](/docs/enterprise) about using anymous in your organization.
