---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala anymous.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

anymous zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie anymous uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI anymous, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do anymous. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij anymous. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `anymous.json`, który konfiguruje zachowanie serwera/runtime.
...
- `leader_timeout` - Określa, jak długo anymous czeka po naciśnięciu leader key. Domyślnie `2000`.
...
- `sound_pack` - ID sound pack do użycia. Domyślnie `anymous.default`.
