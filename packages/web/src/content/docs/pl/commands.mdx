...
Utwórz `.anymous/commands/test.md`:
...
Możesz zdefiniować polecenia w `anymous.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji anymous:
...
- Globalnie: `~/.config/anymous/commands/`
- Na projekt: `.anymous/commands/`
...
anymous zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
