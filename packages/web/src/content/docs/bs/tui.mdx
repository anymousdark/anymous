---
title: TUI
description: Korištenje korisničkog interfejsa anymous terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

anymous pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje anymous pokreće TUI za trenutni direktorij.
...
Kada koristite anymous TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u anymous. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz anymous. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `anymous.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
- `leader_timeout` - Kontroliše koliko dugo anymous čeka nakon leader key. Podrazumijevano je `2000`.
...
- `sound_pack` - Sound pack ID koji se koristi. Podrazumijevano je `anymous.default`.
