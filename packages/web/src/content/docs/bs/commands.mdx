...
Kreiraj `.anymous/commands/test.md`:
...
Možete dodati prilagođene komande kroz anymous konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom anymous [config](/docs/config):
...
- Globalno: `~/.config/anymous/commands/`
- Po projektu: `.anymous/commands/`
...
anymous uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
