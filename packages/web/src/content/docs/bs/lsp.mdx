---
title: LSP serveri
description: anymous se integriše sa vašim LSP serverima.
---

anymous se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

anymous dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `ANYMOUS_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i anymous otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj anymous konfiguraciji.
