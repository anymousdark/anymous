import { anymous } from "@anymous-ai/client/effect"
...
import { createEmbeddedRoutes } from "@anymous-ai/server/routes"
import { Context, Effect, Layer, Scope } from "effect"
import { FetchHttpClient, HttpRouter, HttpServer } from "effect/unstable/http"

export const create = Effect.fn("anymous.create")(function* () {
...
export class Service extends Context.Service<Service, Interface>()("@anymous-ai/sdk-next/anymous") {}
