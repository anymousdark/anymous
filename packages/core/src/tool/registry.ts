...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@anymous-ai/llm"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/v2/ToolRegistry") {}
