...
import type { Data, Definition, Payload } from "@anymous-ai/schema/event"
...
import { Durable } from "@anymous-ai/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@anymous-ai/schema/event").ID
export type { Data, Definition, Payload } from "@anymous-ai/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/Event") {}
