...
import { ListAnchor } from "@anymous-ai/schema/session"
...
import type { PromptInput } from "@anymous-ai/schema/prompt-input"
...
import { SessionDurable } from "@anymous-ai/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/v2/Session") {}
