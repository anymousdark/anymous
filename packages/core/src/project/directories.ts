...
import type { EffectDrizzleSqlite } from "@anymous-ai/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/ProjectDirectories") {}
