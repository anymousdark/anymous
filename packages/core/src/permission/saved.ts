...
import { PermissionSaved } from "@anymous-ai/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/v2/PermissionSaved") {}
