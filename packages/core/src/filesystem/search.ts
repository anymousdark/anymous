...
export class Service extends Context.Service<Service, Interface>()("@anymous/v2/FileSystem/Search") {}
...
const layer = Layer.unwrap(Effect.sync(() => (Flag.ANYMOUS_DISABLE_FFF || !Fff.available() ? ripgrepLayer : fffLayer)))
