...
import { FileSystemWatcher } from "@anymous-ai/schema/filesystem-watcher"
...
declare const ANYMOUS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof ANYMOUS_LIBC === "undefined" ? undefined : ANYMOUS_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@anymous/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.ANYMOUS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.ANYMOUS_EXPERIMENTAL_FILEWATCHER)) {
