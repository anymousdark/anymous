...
const en = {
  "app.title": "AI Model Usage Rankings | anymous Data",
  "app.description":
    "Explore anymous Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "anymous Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star anymous on GitHub",
  "header.github": "GitHub",
  "header.tryanymous": "Try anymous",
  ...
  "home.topModelsDescription": "Usage of models across anymous Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique anymous Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | anymous Data",
  "lab.description":
    "Compare {{lab}} models used in anymous Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent anymous usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in anymous",
  ...
  "lab.shareOfUsage": "{{share}} of recent anymous usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | anymous Data",
  "model.description":
    "View {{model}} anymous Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. anymous Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's anymous Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's anymous Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No anymous Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no anymous Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "anymous Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No anymous Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent anymous Go token volume.",
