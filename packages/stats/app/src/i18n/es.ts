export const dict = {
  "app.title": "Clasificaciones de uso de modelos de IA | anymous Data",
  "app.description":
    "Explora el uso de anymous Go en modelos de IA, incluido el volumen de tokens, clasificaciones, cuota de mercado, precios de tokens, coste por sesión, ratio de caché y desgloses geográficos.",
  "app.unfurlAlt": "Logotipo textual de anymous Data sobre un fondo oscuro con patrón",
  ...
  "header.githubAria": "Dale una estrella a anymous en GitHub",
  "header.github": "GitHub",
  "header.tryanymous": "Probar anymous",
  ...
  "footer.homeAria": "Inicio de anymous",
  ...
  "modal.title": "Boletín de anymous",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos en anymous Go.",
  ...
  "home.uniqueUsersDescription": "Usuarios únicos diarios de anymous Go por modelo.",
  ...
  "lab.title": "Uso y clasificaciones de modelos de IA de {{lab}} | anymous Data",
  "lab.description":
    "Compara modelos de {{lab}} usados en anymous Go, incluido uso de tokens, clasificaciones de modelos, ventanas de contexto, fechas de lanzamiento, costes y datos específicos del modelo.",
  "lab.loadingTitle": "Laboratorio de modelos",
  "lab.loadingDescription": "Leyendo disponibilidad de modelos y uso reciente de anymous.",
  "lab.notFound": "Ningún modelo coincidió con este laboratorio.",
  "lab.heroPrefix": "Explora {{count}} modelos de {{lab}} usados en anymous",
  ...
  "lab.shareOfUsage": "{{share}} del uso reciente de anymous",
  "lab.usageTitle": "Uso de tokens de {{lab}}",
  "lab.usageDescription": "Volumen diario de tokens de anymous durante los últimos dos meses.",
  ...
  "lab.usage": "Uso",
  "lab.share": "Cuota",
  "model.title": "Uso, coste y posición de {{model}} | anymous Data",
  "model.description":
    "Consulta datos de uso de {{model}} en anymous Go, incluido volumen de tokens, posición semanal, mezcla de tokens, costes, ratio de caché, sesiones, desgloses geográficos y modelos similares.",
  ...
  "model.catalogFallback":
    "Datos del modelo desde el índice compartido de modelos. El uso de anymous Go aparecerá cuando este modelo tenga actividad.",
  "model.unranked": "Sin clasificación en el uso de anymous Go de la semana pasada",
  "model.ranked": "Clasificado #{{rank}} en el uso de anymous Go de la semana pasada",
  ...
  "model.noCurrentUsage": "Sin uso de anymous Go en la ventana de datos actual.",
  ...
  "model.overviewDescription": "Tokens recientes de anymous Go, usuarios únicos y posición de mercado.",
  "model.noSummaryTitle": "Sin resumen de uso",
  "model.noSummaryDescription": "Este modelo aún no tiene filas de uso de anymous Go.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volumen diario de tokens de anymous Go durante la ventana reciente de dos meses.",
  ...
  "model.usersDescription": "Usuarios únicos diarios de anymous Go durante la ventana reciente de dos meses.",
  ...
  "model.efficiencyDescription": "Coste, comportamiento de caché y forma media de sesión de anymous Go.",
  ...
  "model.geoDescription": "Tokens del modelo de anymous Go usados por país.",
  "model.noGeoTitle": "Sin datos geográficos",
  "model.noGeoDescription": "Ninguna fila geográfica de anymous Go coincidió con este modelo.",
  "model.worldMap": "Mapa mundial del uso de tokens del modelo por país",
  "model.peersDescription": "Modelos cercanos por volumen reciente de tokens de anymous Go.",
