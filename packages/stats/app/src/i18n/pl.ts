export const dict = {
  "app.title": "Rankingi użycia modeli AI | anymous Data",
  "app.description":
    "Przeglądaj użycie anymous Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny anymous Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę anymous na GitHub",
  "header.github": "GitHub",
  "header.tryanymous": "Wypróbuj anymous",
  ...
  "footer.homeAria": "Strona główna anymous",
  ...
  "home.topModelsDescription": "Użycie modeli w anymous Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy anymous Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | anymous Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w anymous Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia anymous.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w anymous",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia anymous",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów anymous z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | anymous Data",
  "model.description":
    "Zobacz dane użycia {{model}} w anymous Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie anymous Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu anymous Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu anymous Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia anymous Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny anymous Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia anymous Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów anymous Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy anymous Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji anymous Go.",
  ...
  "model.geoDescription": "Tokeny modelu anymous Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne anymous Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów anymous Go.",
