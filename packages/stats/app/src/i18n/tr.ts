export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | anymous Data",
  "app.description":
    "anymous Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde anymous Data logosu",
  ...
  "header.githubAria": "GitHub'da anymous'a yıldız ver",
  "header.github": "GitHub",
  "header.tryanymous": "anymous'u dene",
  ...
  "footer.homeAria": "anymous ana sayfası",
  ...
  "home.topModelsDescription": "anymous Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz anymous Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | anymous Data",
  "lab.description":
    "anymous Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son anymous kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "anymous'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son anymous kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük anymous token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | anymous Data",
  "model.description":
    "{{model}} için anymous Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda anymous Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki anymous Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki anymous Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde anymous Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son anymous Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz anymous Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük anymous Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz anymous Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama anymous Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan anymous Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen anymous Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son anymous Go token hacmine göre yakındaki modeller.",
