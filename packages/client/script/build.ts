...
import { compile, emitEffectImported, emitPromise, write } from "@anymous-ai/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "anymousEventEncoded",
              import: 'import type { anymousEventEncoded } from "@anymous-ai/protocol/groups/event"',
            },
          },
        }),
