...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>anymous | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="anymous terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <h2 id="what-is-anymous">What is anymous?</h2>
              <p>
              ...
              <p>
                ...
                our site located at anymous-cli.vercel.app, send you an email, and/or notify you by some other means.
              </p>
              ...
              <h2 id="what-are-the-basics">What are the basics of using anymous?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by anymous;
                </li>
                <li>
              ...
              <p>
                If you use anymous with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                anymous. Your ability to access Third Party Models is contingent on you having API keys or otherwise
              ...
              <p>
                ...
                <a href="https://anymous-cli.vercel.app/auth">https://anymous-cli.vercel.app/auth</a>.
              </p>
              ...
              <p>
                anymous is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. anymous has the sole right to decide whether you are
              ...
              <p>
                ...
                the anymous Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the anymous Parties harmless from and against any and all claims,
              ...
              <p>
                The Rules will govern payment of all arbitration fees. anymous will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. anymous will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or anymous may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                YOU AND anymous WAIVE ANY CONSTITUTIONAL AND STATUTORY RIGHTS TO GO TO COURT AND HAVE A TRIAL IN FRONT
              ...
              <p>
                ...
                agreement permits either you or anymous to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and anymous agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                are not an employee, agent, partner, or joint venture of anymous, and you do not have any authority of
                any kind to bind anymous in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and anymous
