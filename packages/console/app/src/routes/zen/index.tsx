...
import compareVideo from "../../asset/lander/anymous-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/anymous-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="anymous:auth" content={loggedin() ? "true" : "false"} />
