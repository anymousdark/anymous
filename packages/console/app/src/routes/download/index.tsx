      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://anymous-cli.vercel.app/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>anymous-cli.vercel.app/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g anymous-ai")}>
                <code>
                  npm i -g <strong>anymous-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g anymous-ai")}>
                <code>
                  bun add -g <strong>anymous-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("brew install anomalyco/tap/anymous")}>
                <code>
                  brew install <strong>anomalyco/tap/anymous</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("paru -S anymous")}>
                <code>
                  paru -S <strong>anymous</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask anymous-desktop")}>
                <code>
                  brew install --cask <strong>anymous-desktop</strong>
                </code>
                <CopyStatus />
              </button>
