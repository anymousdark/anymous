...
> current private `@anymous-ai/llm` API. Names and exact TypeScript signatures
> are illustrative until implementation, but the domain boundaries and defaults
> are deliberate.

## Status

- Proposed package: `@anymous-ai/ai`
...
- Secondary audience: anymous and other durable agent runtimes
...
import { LLM } from "@anymous-ai/ai"
import { OpenAI } from "@anymous-ai/ai/providers/openai"
...
```ts
import { Message } from "@anymous-ai/ai"
...
import { LLM, Tool } from "@anymous-ai/ai"
...
anymous and other durable runtimes need to own persistence, tool settlement,
...
```ts
import { LLM } from "@anymous-ai/ai/promise"
import { OpenAI } from "@anymous-ai/ai/providers/openai"
...
```ts
import { LLMSchema } from "@anymous-ai/ai/schema"
...
```ts
import { Provider, Protocol } from "@anymous-ai/ai/provider"
...
@anymous-ai/ai/promise
  Promise/AsyncIterable LLM facade

@anymous-ai/ai/schema
  serializable domain schemas

@anymous-ai/ai/provider
  experimental Provider and Protocol authoring APIs

@anymous-ai/ai/providers/openai
@anymous-ai/ai/providers/anthropic
@anymous-ai/ai/providers/google
...
```
...
anymous should migrate to `generateTurn` / `streamTurn`, preserving its durable
