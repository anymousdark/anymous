...
Schema-first LLM core for anymous. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@anymous-ai/llm"
import { OpenAI } from "@anymous-ai/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@anymous-ai/llm/providers"
