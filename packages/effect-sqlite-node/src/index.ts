...
export const TypeId: TypeId = "~@anymous-ai/effect-sqlite-node/NodeSqliteClient"
export type TypeId = "~@anymous-ai/effect-sqlite-node/NodeSqliteClient"
...
export const SqliteClient = Context.Service<SqliteClient>("@anymous-ai/effect-sqlite-node/NodeSqliteClient")
