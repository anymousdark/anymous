...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "anymous.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/anymous/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/anymous (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/anymous/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/anymous/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const ANYMOUS_DB|ANYMOUS_DB|ANYMOUS_DEV|Global\\.Path\\.data|data =" in packages/anymous/src (115 matches)',
  },
] as const
