...
import type { AssistantMessage, FilePart, UserMessage } from "@anymous-ai/sdk/v2"
...
import { ANYMOUS_BASE_MODE, useBindings, useCommandShortcut, useLeaderActive, useanymousKeymap } from "../../keymap"
  ...
  const promptCommands = createMemo(() =>
    [
      ...
      },
      {
        ...
        name: "workspace.set",
        category: "Session",
        enabled: Flag.ANYMOUS_EXPERIMENTAL_WORKSPACES,
        slashName: "warp",
        run: () => {
          workspace.open()
        },
