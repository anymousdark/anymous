...
class Database extends Context.Service<Database, DatabaseShape>()("@anymous/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@anymous/example/UserStore") {
