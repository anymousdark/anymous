...
const releaseId = process.env.ANYMOUS_RELEASE
if (!releaseId) throw new Error("ANYMOUS_RELEASE is required")

const version = process.env.ANYMOUS_VERSION
if (!version) throw new Error("ANYMOUS_VERSION is required")
...
const macxTarGz = "anymous-desktop-mac-x64.app.tar.gz"
const macaTarGz = "anymous-desktop-mac-arm64.app.tar.gz"
