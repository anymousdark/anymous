...
describe("electron vite publicDir", () => {
  test("configured publicDir resolves to a directory with anymous-theme-preload.js", async () => {
    ...
    expect(existsSync(join(resolved, "anymous-theme-preload.js"))).toBe(true)
  })
})
