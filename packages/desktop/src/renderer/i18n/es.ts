export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de anymous",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de anymous. ¿Quieres instalarla y reiniciar?",
