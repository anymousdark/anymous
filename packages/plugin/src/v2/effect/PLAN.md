...
- Effect plugins import `@anymous-ai/plugin/v2/effect`, not `@anymous-ai/core`.
- Public domain values use generated `@anymous-ai/sdk` types.
...
- Define `PluginHost` domain capabilities in `@anymous-ai/plugin/v2/effect`.
