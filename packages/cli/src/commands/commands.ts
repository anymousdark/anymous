...
declare const ANYMOUS_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof ANYMOUS_CLI_NAME === "string" ? ANYMOUS_CLI_NAME : "anymous", {
  description: "anymous 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
