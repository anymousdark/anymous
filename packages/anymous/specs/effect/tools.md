...
Practical reference for the current tool-migration state in `packages/anymous`.
...
Tool tests should use the existing Effect helpers in `packages/anymous/test/lib/effect.ts`:
