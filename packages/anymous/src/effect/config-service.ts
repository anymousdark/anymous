 ...
 *   "@anymous/ServerAuthConfig",
 *   {
 *     password: Config.string("ANYMOUS_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("ANYMOUS_SERVER_USERNAME").pipe(Config.withDefault("anymous")),
 *   },
 * ) {}
 *
