...
import { EventSequenceTable, EventTable } from "@anymous-ai/core/event/sql"
...
import { WorkspaceEvent } from "@anymous-ai/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        ANYMOUS_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        ANYMOUS_WORKSPACE_ID: config.id,
        ANYMOUS_EXPERIMENTAL_WORKSPACES: "true",
