...
//
// The saved variant persists across sessions in ~/.local/state/anymous/model.json
...
class Service extends Context.Service<Service, VariantService>()("@anymous/RunVariant") {}
