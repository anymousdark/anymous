...
import type { Event, GlobalEvent, anymousClient } from "@anymous-ai/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@anymous/RunStreamTransport") {}
