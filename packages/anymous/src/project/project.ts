...
import { ProjectDirectoryTable, ProjectTable } from "@anymous-ai/core/project/sql"
import { ProjectDirectories } from "@anymous-ai/core/project/directories"
...
import { Effect, Layer, Scope, Context, Stream, Schema } from "effect"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.ANYMOUS_FAKE_VCS)
