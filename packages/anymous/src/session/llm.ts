...
import { llmClient } from "@anymous-ai/core/effect/app-node-platform"
...
import type { LLMEvent } from "@anymous-ai/llm"
import { LLMClient } from "@anymous-ai/llm/route"
import type { LLMClientService } from "@anymous-ai/llm/route"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/LLM") {}
...
> = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const run = Effect.fn("LLM.run")(function* (input: StreamRequest) {
      ...
      // from the workflow service are executed via anymous's tool system
      ...
      // Runtime seam: native is an opt-in adapter over @anymous-ai/llm. It
