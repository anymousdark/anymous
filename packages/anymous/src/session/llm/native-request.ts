import type { JsonSchema, LLMRequest, ProviderMetadata } from "@anymous-ai/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@anymous-ai/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @anymous-ai/llm request objects from anymous's session/AI SDK-shaped data.
  return LLM.request({
