...
const USER_AGENT = `anymous/${InstallationVersion}`
...
export const prepare = Effect.fn("LLMRequestPrep.prepare")(function* (input: PrepareInput) {
  ...
  const anymousProjectID = input.model.providerID.startsWith("anymous")
  ...
  return {
    ...
    headers: {
      ...(input.model.providerID.startsWith("anymous")
        ? {
            ...(anymousProjectID ? { "x-anymous-project": anymousProjectID } : {}),
            "x-anymous-session": input.sessionID,
            "x-anymous-request": input.user.id,
            "x-anymous-client": input.flags.client,
