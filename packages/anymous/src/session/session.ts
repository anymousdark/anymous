...
import { Slug } from "@anymous-ai/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@anymous-ai/llm"
...
import { locationServiceMapLayer } from "@anymous-ai/core/location-services"
...
import { PartTable, SessionTable } from "@anymous-ai/core/session/sql"
...
import { NonNegativeInt, optional } from "@anymous-ai/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".anymous", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@anymous/Session") {}
