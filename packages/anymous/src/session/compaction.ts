...
import { buildPrompt } from "@anymous-ai/core/session/compaction"
import { SessionCompactionEvent } from "@anymous-ai/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@anymous/SessionCompaction") {}
