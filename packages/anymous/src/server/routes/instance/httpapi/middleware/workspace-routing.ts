...
>()("@anymous/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@anymous/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.ANYMOUS_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.ANYMOUS_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-anymous-directory"] || process.cwd()
}
