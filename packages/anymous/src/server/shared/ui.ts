...
export const UI_UPSTREAM = new URL("https://app.anymous-cli.vercel.app")
...
export function embeddedUI(disableEmbeddedWebUi: boolean) {
  ...
  return (embeddedUIPromise ??=
    ...
    import("anymous-web-ui.gen.ts").then((module) => module.default as Record<string, string>).catch(() => null))
}
