import type { Hooks, PluginInput } from "@anymous-ai/plugin"
import type { Model } from "@anymous-ai/sdk/v2"
import { InstallationVersion } from "@anymous-ai/core/installation/version"
import { OauthCallbackPage } from "@anymous-ai/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. anymous will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
