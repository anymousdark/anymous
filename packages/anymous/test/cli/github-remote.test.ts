...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/anymous.git")).toEqual({ owner: "sst", repo: "anymous" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/anymous")).toEqual({ owner: "sst", repo: "anymous" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/anymous.git")).toEqual({ owner: "sst", repo: "anymous" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/anymous")).toEqual({ owner: "sst", repo: "anymous" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/anymous.git")).toEqual({ owner: "sst", repo: "anymous" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/anymous")).toEqual({ owner: "sst", repo: "anymous" })
})
