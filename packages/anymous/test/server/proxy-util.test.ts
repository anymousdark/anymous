...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips anymous-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-anymous-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-anymous-directory")).toBeNull()
      expect(result.get("x-anymous-workspace")).toBeNull()
