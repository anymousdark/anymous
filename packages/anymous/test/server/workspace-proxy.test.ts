...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips anymous-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-anymous-directory"]).toBeUndefined()
      expect(forwarded["x-anymous-workspace"]).toBeUndefined()
