...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders ANYMOUS_CALLER", () => {
    process.env["ANYMOUS_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode ANYMOUS_CALLER", () => {
    process.env["ANYMOUS_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown ANYMOUS_CALLER", () => {
    process.env["ANYMOUS_CALLER"] = "unknown"
